...
public abstract class BaseVOrg<M extends BaseVOrg<M>> extends Model<M> implements IBean {
	...
	public M setCountryIndex(java.lang.String countryIndex) {
		set("countryIndex", countryIndex);
		return (M)this;
	}
	
	public java.lang.String getCountryIndex() {
		return getStr("countryIndex");
	}

	public M setCityIndex(java.lang.String cityIndex) {
		set("cityIndex", cityIndex);
		return (M)this;
	}
	
	public java.lang.String getCityIndex() {
		return getStr("cityIndex");
	}

	public M setAreaIndex(java.lang.String areaIndex) {
		set("areaIndex", areaIndex);
		return (M)this;
	}
	
	public java.lang.String getAreaIndex() {
		return getStr("areaIndex");
	}
